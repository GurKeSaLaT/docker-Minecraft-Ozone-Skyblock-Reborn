# [Ozone Skyblock Reborn - 1.19](https://www.curseforge.com/minecraft/modpacks/ozone-skyblock-reborn) on Curseforge
...
The docker on first run will download the same version as tagged of Ozone Skyblock Reborn and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "SkyFactory 4 - 4.2.4 Server Powered by Docker"
* LEVEL world
...
Github: https://github.com/GurKeSaLaT/docker-Minecraft-Ozone-Skyblock-Reborn
Docker: https://hub.docker.com/repository/docker/gurkesalat/minecraft-ozone-skyblock-reborn
